...
void CResMgr::CreateDefaultGraphicsShader()
{
	...
	// ============================
	// SkyBoxShader
	// RS_TYPE : CULL_FRONT (SkyBox는 내면을 보는 방식이기 때문에 CULL_FRONT사용)
	// DS_TYPE : LESS_EQUAL 
	// BS_TYPE : DEFAULT
	// Domain : MASK
	// ============================
	...
	// Parameter	
	pShader->AddTexParam(TEX_0, "Output Texture1");
	pShader->AddTexParam(TEX_CUBE_0, "Output Texture2");
	...
	// ============================
	// Std3D_Deferred_Decal
	// RS_TYPE : CULL_FRONT
	// DS_TYPE : NO_TEST_NO_WRITE
	// BS_TYPE : DEFEREED_DECAL_BLEND
	// Domain : DEFERRED_DECAL
	// ============================
	pShader = new CGraphicsShader;
